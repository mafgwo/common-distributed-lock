...
public class BusinessKeyProvider {
    ...
    public String getKeyName(ProceedingJoinPoint joinPoint, DistributedLock distributedLock) {
        List<String> keyList = new ArrayList<>();
        Method method = getMethod(joinPoint);
        List<String> definitionKeys = getSpelDefinitionKey(distributedLock.keys(), method, joinPoint.getArgs());
